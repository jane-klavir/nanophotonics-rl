#!/usr/bin/env python3
"""
Verbatim copy of miepython's examples/04_gold.py, with plt.show() enabled and
the figure saved to outputs/figures/04_gold.png. Source:
https://github.com/scottprahl/miepython/blob/main/miepython/examples/04_gold.py
"""
...
ref_lam = np.array(
    [
        0.1879, 0.1916, 0.1953, 0.1993, 0.2033, 0.2073, 0.2119, 0.2164, 0.2214,
        0.2262, 0.2313, 0.2371, 0.2426, 0.2490, 0.2551, 0.2616, 0.2689, 0.2761,
        ...
        0.5821, 0.6168, 0.6595, 0.7045, 0.7560, 0.8211, 0.8920, 0.9840, 1.0880,
        1.2160, 1.3930, 1.6100, 1.9370,
    ]
)

ref_n = np.array(
    [
        1.28, 1.32, 1.34, 1.33, 1.33, 1.30, 1.30, 1.30, 1.30, 1.31, 1.30, 1.32,
        1.32, 1.33, 1.33, 1.35, 1.38, 1.43, 1.47, 1.49, 1.53, 1.53, 1.54, 1.48,
        1.48, 1.50, 1.48, 1.46, 1.47, 1.46, 1.45, 1.38, 1.31, 1.04, 0.62, 0.43,
